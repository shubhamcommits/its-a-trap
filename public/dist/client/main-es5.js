...
var AgricultureComponent = /** @class */ (function () {
    function AgricultureComponent(managerService) {
        this.managerService = managerService;
    }
    AgricultureComponent.prototype.ngOnInit = function () {
    };
    AgricultureComponent.prototype.predict = function () {
        var _this = this;
        //console.log(this.crop, this.state);
        this.managerService.getRainfallJSON()
            .subscribe(function (res) {
            _this.value = _this.crop;
            console.log(_this.value);
            _this.managerService.getJSON()
                .subscribe(function (resp) {
                for (var i in resp) {
                    if (_this.crop === resp[i]['type'] && resp[i]['rainfall'] < _this.value) {
                        console.log(resp[i]);
                        // this.managerService.getRainfallJSON()
                        // .subscribe((resp)=>{})
                    }
    ...
    AgricultureComponent.ctorParameters = function () { return [
...
var BlockchainComponent = /** @class */ (function () {
    function BlockchainComponent(blockchainService, ngxService) {
    ...
    BlockchainComponent.prototype.thereArePendingTransactions = function () {
        return this.blockchain.pendingTransactions.length > 0;
    };
    BlockchainComponent.ctorParameters = function () { return [
...
var CreateTransactionComponent = /** @class */ (function () {
    function CreateTransactionComponent(blockchainService, router, ngxService) {
        this.blockchainService = blockchainService;
        this.router = router;
        this.ngxService = ngxService;
...
var PendingTransactionsComponent = /** @class */ (function () {
    function PendingTransactionsComponent(blockchainService, router, route, ngxService) {
        this.blockchainService = blockchainService;
        this.router = router;
        this.route = route;
        this.ngxService = ngxService;
...
var SettingsComponent = /** @class */ (function () {
    function SettingsComponent(blockchainService, ngxService) {
        this.blockchainService = blockchainService;
        this.ngxService = ngxService;
        this.blockchain = blockchainService.blockchainInstance;
    }
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(ngxService) {
        this.ngxService = ngxService;
    }
...
var LmsComponent = /** @class */ (function () {
    function LmsComponent() {
    }
    LmsComponent.prototype.ngOnInit = function () {
    };
...
var LoginFundShgComponent = /** @class */ (function () {
    function LoginFundShgComponent() {
    }
    LoginFundShgComponent.prototype.ngOnInit = function () {
    };
...
var LoginFundComponent = /** @class */ (function () {
    function LoginFundComponent() {
    }
    LoginFundComponent.prototype.ngOnInit = function () {
    };
...
var LoginJoinShgComponent = /** @class */ (function () {
    function LoginJoinShgComponent(managerService, shgService, mentorService, userService, authService, _location, router) {
        this.managerService = managerService;
    ...
    LoginJoinShgComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    LoginJoinShgComponent.prototype.joinTheSHG = function (shg_id) {
        var _this = this;
        this.userService.joinSHG(shg_id, this.user._id)
            .subscribe(function (res) {
            console.log("One" + res);
            console.log("Here" + shg_id);
            _this.shgService.getSHG(shg_id)
                .subscribe(function (res2) {
                console.log("Two", res2);
                var shgData = res2['shg'];
                console.log("ID" + shgData['mentor']);
                _this.mentorService.addMentee(shgData['mentor'], _this.user._id)
                    .subscribe(function (res3) {
                    console.log("Three", res3);
                    _this.shgService.addMentee(shg_id, _this.user._id)
                        .subscribe(function (res4) {
                        console.log("Four", res4);
                        _this.authService.partOfSHG.next(true);
                        localStorage.setItem('User', JSON.stringify(res['user']));
                        _this.router.navigate(['user', 'my-shg']);
                    });
                });
            });
        });
    };
    LoginJoinShgComponent.ctorParameters = function () { return [
        { type: src_shared_manager_service__WEBPACK_IMPORTED_MODULE_2__["ManagerService"] },
...
var LoginMyShgComponent = /** @class */ (function () {
    function LoginMyShgComponent(managerService, shgService, mentorService, authService) {
        this.managerService = managerService;
        this.shgService = shgService;
        this.mentorService = mentorService;
        this.authService = authService;
    }
    LoginMyShgComponent.prototype.ngOnInit = function () {
        var _this = this;
        ...
        this.shgService.getSHG(this.user.shg)
            ...
            console.log(res);
            _this.shg = res['shg'];
            _this.mentorService.getMentor(_this.shg.mentor)
                .subscribe(function (res1) {
                console.log(res1);
                _this.mentor = res1['mentor'];
            });
            _this.managerService.getManager(_this.shg.manager)
                .subscribe(function (res1) {
                console.log(res1);
                _this.manager = res1['manager'];
            });
        });
    };
    LoginMyShgComponent.ctorParameters = function () { return [
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(ngxService, authService, _location, router) {
        this.ngxService = ngxService;
        this.authService = authService;
        this._location = _location;
        this.router = router;
    ...
    LoginComponent.prototype.loginUser = function () {
        ...
        this.authService.loginUser(_loginData)
            .subscribe(function (res) {
            _this.authService.loggedUser.next("user");
            ...
            if (res['user']['shg']) {
                ...
                _this.authService.partOfSHG.next(false);
                _this.router.navigate(['user', 'join-shg']);
            }
        }, function (err) {
...
var ManagerDashboardComponent = /** @class */ (function () {
    function ManagerDashboardComponent(managerService, shgService, mentorService) {
        this.managerService = managerService;
        this.shgService = shgService;
        this.mentorService = mentorService;
    ...
    ManagerDashboardComponent.prototype.getMentors = function () {
        var _this = this;
            ...
            if (this.manager.mentors.length > 0) {
                for (var i = 0; i < this.manager.mentors.length; i++) {
                    ...
                    this.mentorService.getMentor(this.manager.mentors[i])
                        .subscribe(function (res) {
                        var shg_id = res['mentor']['shg'];
                        if (shg_id) {
                            _this.shgService.getSHG(shg_id)
                                .subscribe(function (resp) {
                                _this.mentor_shg.push({
                                    'mentor': res['mentor'],
                                    'shg': resp['shg']
                                });
                            });
    ...
    ManagerDashboardComponent.ctorParameters = function () { return [
        { type: src_shared_manager_service__WEBPACK_IMPORTED_MODULE_2__["ManagerService"] },
        { type: src_shared_shg_service__WEBPACK_IMPORTED_MODULE_4__["ShgService"] },
        { type: src_shared_mentor_service__WEBPACK_IMPORTED_MODULE_3__["MentorService"] }
    ]; };
...
var ManagerLoginComponent = /** @class */ (function () {
    function ManagerLoginComponent(authService, _location, ngxService, router) {
        this.authService = authService;
        this._location = _location;
        this.ngxService = ngxService;
        this.router = router;
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!!localStorage.getItem('Manager')) return [3 /*break*/, 2];
    ...
    ManagerLoginComponent.prototype.loginManager = function () {
        var _this = this;
        var _loginData = {
            email: this.email,
            password: this.password
        ...
        this.authService.loginManager(_loginData)
            ...
            _this.authService.loggedUser.next("manager");
            localStorage.setItem('Manager', JSON.stringify(res['manager']));
            localStorage.setItem('Token', JSON.stringify(res['token']));
            _this.router.navigate(['manager', 'dashboard']);
        }, function (err) {
            console.log('Error fetched', err);
        });
    };
    ManagerLoginComponent.ctorParameters = function () { return [
        { type: src_shared_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"] },
...
var ManagerMentorShgDetailComponent = /** @class */ (function () {
    function ManagerMentorShgDetailComponent(activatedRoute, shgService, mentorService) {
    ...
    ManagerMentorShgDetailComponent.prototype.ngOnInit = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.mentorService.getMentor(this.mentor_id)
                            .subscribe(function (res) {
                            var shg_id = res['mentor']['shg'];
                            if (shg_id) {
                                _this.shgService.getSHG(shg_id)
    ...
    ManagerMentorShgDetailComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
        { type: src_shared_shg_service__WEBPACK_IMPORTED_MODULE_4__["ShgService"] },
        { type: src_shared_mentor_service__WEBPACK_IMPORTED_MODULE_3__["MentorService"] }
    ]; };
    ...
    return ManagerMentorShgDetailComponent;
}());
...
var ManagerPendingMentorsComponent = /** @class */ (function () {
    function ManagerPendingMentorsComponent(managerService, mentorService, shg) {
        this.managerService = managerService;
        this.mentorService = mentorService;
        this.shg = shg;
        this.pending_mentors = new Array();
    }
    ManagerPendingMentorsComponent.prototype.ngOnInit = function () {
        this.manager = JSON.parse(localStorage.getItem('Manager'));
        console.log(this.manager);
        this.getPendingMentors();
    };
    ManagerPendingMentorsComponent.prototype.getPendingMentors = function () {
        var _this = this;
            ...
            if (this.manager.pending_mentors.length > 0) {
                for (var i = 0; i < this.manager.pending_mentors.length; i++) {
                    this.mentorService.getMentor(this.manager.pending_mentors[i])
                        ...
                        _this.pending_mentors.push(res['mentor']);
                    });
                }
            }
        }
    };
    ManagerPendingMentorsComponent.prototype.acceptMentor = function (mentor_id) {
        var _this = this;
        console.log(mentor_id);
        this.managerService.acceptPendingManager(mentor_id, this.manager._id)
            .subscribe(function (res) {
            console.log(res);
            _this.mentorService.addManager(mentor_id, _this.manager._id)
                .subscribe(function (resp) {
                console.log(resp);
            });
        });
    };
    ManagerPendingMentorsComponent.ctorParameters = function () { return [
        { type: src_shared_manager_service__WEBPACK_IMPORTED_MODULE_2__["ManagerService"] },
        { type: src_shared_mentor_service__WEBPACK_IMPORTED_MODULE_3__["MentorService"] },
        { type: src_shared_shg_service__WEBPACK_IMPORTED_MODULE_4__["ShgService"] }
    ]; };
    ...
    return ManagerPendingMentorsComponent;
}());
...
var ManagerPendingShgsComponent = /** @class */ (function () {
    function ManagerPendingShgsComponent(managerService) {
        this.managerService = managerService;
        this.pending_shgs = new Array();
    }
    ManagerPendingShgsComponent.prototype.ngOnInit = function () {
        this.mentor = JSON.parse(localStorage.getItem('Manager'));
        console.log(this.mentor);
    };
    ManagerPendingShgsComponent.prototype.getPendingSHG = function () {
    ...
    ManagerPendingShgsComponent.ctorParameters = function () { return [
        { type: src_shared_manager_service__WEBPACK_IMPORTED_MODULE_2__["ManagerService"] }
    ]; };
    ...
    return ManagerPendingShgsComponent;
}());
...
var ManagerSignupComponent = /** @class */ (function () {
    function ManagerSignupComponent(_location, authService, ngxService, router) {
        this._location = _location;
        this.authService = authService;
        this.ngxService = ngxService;
        this.router = router;
    }
    ManagerSignupComponent.prototype.ngOnInit = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var password;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, sweetalert2__WEBPACK_IMPORTED_MODULE_2___default.a.fire({
                                title: 'Enter Global Password',
                                input: 'password',
                                inputPlaceholder: 'Enter your password',
                                inputAttributes: {
    ...
    ManagerSignupComponent.prototype.signupManager = function () {
        var _this = this;
        var _signupData = {
    ...
    ManagerSignupComponent.ctorParameters = function () { return [
...
var MentorApplyShgComponent = /** @class */ (function () {
    function MentorApplyShgComponent() {
    }
    MentorApplyShgComponent.prototype.ngOnInit = function () {
    };
    ...
    return MentorApplyShgComponent;
}());
...
var MentorLmsComponent = /** @class */ (function () {
    function MentorLmsComponent() {
    }
    MentorLmsComponent.prototype.ngOnInit = function () {
    };
...
var MentorLoginComponent = /** @class */ (function () {
    function MentorLoginComponent(authService, ngxService) {
        this.authService = authService;
        this.ngxService = ngxService;
    }
    MentorLoginComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.ngxService.start(); // start foreground loading with 'default' id
        // Stop the foreground loading after 5s
        setTimeout(function () {
    ...
    MentorLoginComponent.prototype.loginMentor = function () {
        var _loginData = {
            email: this.email,
            password: this.password
        };
    ...
    MentorLoginComponent.ctorParameters = function () { return [
        { type: src_shared_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"] },
        { type: ngx_ui_loader__WEBPACK_IMPORTED_MODULE_3__["NgxUiLoaderService"] }
    ]; };
...
var MentorMyShgComponent = /** @class */ (function () {
    function MentorMyShgComponent() {
        this.SSGaccepted = false;
    }
    MentorMyShgComponent.prototype.ngOnInit = function () {
...
var MentorSignupComponent = /** @class */ (function () {
    function MentorSignupComponent(authService, ngxService) {
        this.authService = authService;
        this.ngxService = ngxService;
    }
    MentorSignupComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.ngxService.start(); // start foreground loading with 'default' id
        // Stop the foreground loading after 5s
        setTimeout(function () {
    ...
    MentorSignupComponent.prototype.signupMentor = function () {
        var _signupData = {
            first_name: this.first_name,
            last_name: this.last_name,
            email: this.email,
    ...
    MentorSignupComponent.ctorParameters = function () { return [
        { type: src_shared_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"] },
        { type: ngx_ui_loader__WEBPACK_IMPORTED_MODULE_3__["NgxUiLoaderService"] }
    ]; };
...
var NavbarComponent = /** @class */ (function () {
    function NavbarComponent(authService) {
        var _this = this;
        this.authService = authService;
        this.authService.loggedUser.subscribe(function (value) {
            _this.current_user = value;
        });
        this.authService.partOfSHG.subscribe(function (value) {
            _this.partOfSHG = value;
        });
        this.authService.hasCreatedSHG.subscribe(function (value) {
            _this.hasCreatedSHG = value;
        });
    }
...
var SignupComponent = /** @class */ (function () {
    function SignupComponent(ngxService, authService) {
        this.ngxService = ngxService;
        this.authService = authService;
    }
    /**
...
var VegetationComponent = /** @class */ (function () {
    function VegetationComponent(managerService) {
        this.managerService = managerService;
    }
    VegetationComponent.prototype.ngOnInit = function () {
    };
    VegetationComponent.prototype.predict = function () {
        var _this = this;
        console.log(this.state, this.district, this.month);
        this.managerService.getVegJSON()
            .subscribe(function (res) {
            if (res['Haryana']) {
                if (res['Haryana']["" + _this.district]) {
                    // if(res['Haryana'][`${this.district}`][`${this.month}`]){
                    _this.output = res['Haryana']["" + _this.district];
                    console.log(_this.output['Jan']);
                    // }
                }
            }
        });
    };
    VegetationComponent.ctorParameters = function () { return [
        { type: src_shared_manager_service__WEBPACK_IMPORTED_MODULE_2__["ManagerService"] }
    ]; };
...
var AuthService = /** @class */ (function () {
    ...
    //   return this.data;
    // }
    AuthService.prototype.loginMentor = function (_loginData) {
        //this.loggedUser.next("mentor");
    ...
    AuthService.prototype.loginManager = function (_loginData) {
...
var ManagerService = /** @class */ (function () {
    ...
    ManagerService.prototype.getManager = function (manager_id) {
        var manager = {
            manager_id: manager_id
        };
        return this._http.post(this.BASE_API_URL + "/data/manager/get-manager", manager);
    };
    ManagerService.prototype.getPendingSHG = function (shg_id) {
        var shg = {
            shg_id: shg_id
        };
        return this._http.post(this.BASE_API_URL + "/data/shg/get-shg", shg);
    };
    ManagerService.prototype.acceptPendingManager = function (mentor_id, manager_id) {
        var mentor = {
            mentor_id: mentor_id,
            manager_id: manager_id
        };
    ...
    ManagerService.prototype.addPendingSHG = function () {
    };
    ManagerService.prototype.getJSON = function () {
        return this._http.get('../assets/JSONs/crop.json');
    };
    ManagerService.prototype.getVegJSON = function () {
        return this._http.get('../assets/JSONs/deforestation.json');
    };
    ManagerService.prototype.getRainfallJSON = function () {
...
var MentorService = /** @class */ (function () {
    function MentorService(_http) {
        this._http = _http;
        this.BASE_API_URL = src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].BASE_API_URL;
    }
    MentorService.prototype.getMentor = function (mentor_id) {
        var mentor = {
            mentor_id: mentor_id
        };
        return this._http.post(this.BASE_API_URL + "/data/mentor/get-mentor", mentor);
    };
    MentorService.prototype.addManager = function (mentor_id, manager_id) {
        var comb = {
            mentor_id: mentor_id,
            manager_id: manager_id
        };
    ...
    MentorService.prototype.addMentee = function (mentor_id, user_id) {
        var comb = {
            mentor_id: mentor_id,
            user_id: user_id
        };
...
var ShgService = /** @class */ (function () {
    function ShgService(_http) {
        this._http = _http;
        this.BASE_API_URL = src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].BASE_API_URL;
    }
    ShgService.prototype.getSHG = function (shg_id) {
        var shg = {
            shg_id: shg_id
        };
        return this._http.post(this.BASE_API_URL + "/data/shg/get-shg", shg);
    };
    ShgService.prototype.getAllSHG = function () {
        return this._http.get(this.BASE_API_URL + "/data/shg/get-all-shgs");
    };
    ShgService.prototype.addMentee = function (shg_id, user_id) {
        var shg = {
            shg_id: shg_id,
            user_id: user_id
        };
    ...
    ShgService.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
    ]; };
...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.joinSHG = function (shg_id, user_id) {
        var comb = {
            shg_id: shg_id,
            user_id: user_id
        };
